<div class="table-responsive mt-5 mb-5 pt-3 ">
    <h3 class="mt-5">Mi Historial como Coautor</h3>
    <table class="table">
    <thead>
        <tr>
        ...
        <?php
            ...
            require "../../modelo/trabajosRegistrados.php";
                ...
                while($fetchTrabajosRegistradosCoautor = mysqli_fetch_assoc($resTrabajosRegistradosCoautor)){
                    ...
                    $idCongreso=$fetchTrabajosRegistradosCoautor['id_congreso'];
                    $videoPonencia=$fetchTrabajosRegistradosCoautor['video_ponencia'];
...
//echo "<br> Layouts/historialTrabajosCoautor ".$consUsuarioRevisionPonencia."<br>";
