...
$mail->Subject = "Registro de pago aprobado";
$mail->isHTML(true);
$mail->CharSet = 'UTF-8';
$email2 = '';
$mensaje = '';
...
// if ($_SESSION['correoElectronico'] !== $email2) {
    ...
    $mensaje .= "Estimado participante del Congreso Internacional Sobre la Enseñanza y Aplicación de las Matemáticas con sede en la Facultad de Estudios Superiores Cuautitlán, es grato para el comité organizador informarle que el registro de su pago ha sido validado y APROBADO.<br><br>

        Tu asistencia a sido confirmada, ahora puede ingresar a la plataforma y participar de las diferentes actividades programadas para el desarrollo del congreso. <br><br>";
