...
if ($rutaPdf) enviarWhatsappPdf($_tel, $rutaPdf, "Observaciones sobre tu extenso $idPonencia");
if(count($coautores)!=0){
    for ($i=0; $i <=count($coautores)-1; $i++) {
        ...
        if ($rutaPdf) enviarWhatsappPdf($_telC, $rutaPdf, "Observaciones sobre el extenso $idPonencia");
    }
}
