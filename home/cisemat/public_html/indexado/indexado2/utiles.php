       ...
       // echo "Campo key ;".$Campo["key"]."<BR>";
        ...
        if ($Campo["key"]=="Nombre")
        {
          ...
          $enunSQL = "
                       ...
                       and id_ponencia_oral='".$id_ponencia."'  order by id_ponencia_oral,Nombre;";
          ...
          // Ponencias taller
           ...
           $enunSQL = "
                       ...
                       and upper(concat(nombre_usuario,' ',apellido_paterno,' ',apellido_materno))<>'".$Nombre."'
                       and id_ponencia_taller='".$id_ponencia."'  order by id_ponencia_taller,nombre;";
            //*/
          // Ponencias Cartel
         /* 
          $enunSQL = "
                      Select id_ponencia_cartel,titulo_cartel,upper(concat(nombre_usuario,' ',apellido_paterno,' ',apellido_materno))
                       ...
                       and upper(concat(nombre_usuario,' ',apellido_paterno,' ',apellido_materno))<>'".$Nombre."'
                       and id_ponencia_cartel='".$id_ponencia."'  order by id_ponencia_cartel,nombre;";
         ...
         ///* 
          ...
          $row_cnt= mysqli_num_rows($newTable);
          echo "Numero de filas 5 =  ".$row_cnt."<br>";
